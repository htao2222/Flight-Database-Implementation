...
<html>
	...
	<body>
		...
		<marquee>Kevan Patel / Steven Zyontz / Henry Tao / Neerej Selvakumar / Group 42</marquee> <!-- the usual HTML way -->
		...
		<form method="post" action="show.jsp">
		  ...
		  <input type="radio" name="command" value="login" checked/>Login
		  <br>
		  ...
		  <br>
		  Password: <input type="password" name="password" minlength=5 maxlength=50>
		  <br>
